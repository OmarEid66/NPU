...
//  uart_apb_sys.sv
//
//  UART-APB bridge + APB splitter only.
//  All 8 slave ports are exposed — connect externally.
//  No peripheral logic inside this module.
//
//  Slave address slots (SLOT_BITS=13 → 8 KB each):
//    Slave 0 : 0x0000_0000 – 0x0000_1FFF  ← NPU (connect to npu_apb_decoder)
...
module uart_apb_sys #(
    ...
    // ── Slave 0 (connect to npu_apb_decoder) ─────────────────────────────────
    output wire                  S0_PSEL,
    ...
    // =========================================================================
    // Map splitter → slave ports (shared signals: all slaves get same bus)
    // =========================================================================
