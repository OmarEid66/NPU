...
module TRSRL #(
    ...
    input  logic [N_SIZE-1:0][DATAWIDTH-1:0] act_in,   // parallel activation input lanes
    output logic [N_SIZE-1:0][DATAWIDTH-1:0] act_out    // skewed activation output lanes
);
