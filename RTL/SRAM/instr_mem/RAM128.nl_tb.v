...
module RAM128_tb;
    ...
    task write_word(input [6:0] addr, input [15:0] data);
        begin
            @(posedge CLK);
            EN0 = 1;
            WE0 = ~(2'h0);
    ...
    initial begin
        $dumpfile("RAM128_tb.vcd");
        $dumpvars(0, RAM128_tb);
