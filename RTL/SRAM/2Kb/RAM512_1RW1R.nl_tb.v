...
module RAM512_1RW1R_tb;
    ...
    task write_word(input [8:0] addr, input [31:0] data);
        begin
            @(posedge CLK);
            EN0 = 1;
            WE0 = ~(4'h0);
    ...
    initial begin
        $dumpfile("RAM512_1RW1R_tb.vcd");
        $dumpvars(0, RAM512_1RW1R_tb);
        ...
        for (i = 0; i < 16; i = i + 1) begin
            ...
            EN0 = 0; EN1 = 0;
            @(posedge CLK);
            $display("  Port0 A0=%0d Do0=0x%08h | Port1 A1=%0d Do1=0x%08h",
                     i, Do0, 16 - 1 - i, Do1);
            if (Do0 !== (i * 8'hAB + 8'h10)) errors = errors + 1;
            if (Do1 !== ((16 - 1 - i) * 8'hAB + 8'h10)) errors = errors + 1;
        end
